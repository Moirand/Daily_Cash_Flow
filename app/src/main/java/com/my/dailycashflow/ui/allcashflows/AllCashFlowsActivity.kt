...
class AllCashFlowsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(findViewById<RecyclerView>(R.id.recyclerview_cashflows)){
            layoutManager = LinearLayoutManager(this@AllCashFlowsActivity)
            adapter = adapterListCashFlow
        }

        viewModel.cashFlowsByType.observe(this){
            adapterListCashFlow.submitData(lifecycle, it)
        }
    }
